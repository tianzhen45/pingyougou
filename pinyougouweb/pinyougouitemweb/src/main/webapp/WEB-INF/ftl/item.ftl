                    ...
                    <div class="zoom">
                        ...
                        <div class="spec-scroll">
                            ...
                            <div class="items">
                                <ul>
                                    <#list imageList as i>
                                        <li><img src="${i.url}" bimg="${i.url}" onmousemove="preview(this)"/></li>
                                    </#list>
                                </ul>
                            </div>
                            <a class="next">&gt;</a>
                        ...
                        <div id="specification" class="summary-wrap clearfix">
                             ...
                             <#list specList as spec>
                                <dl>
                                    ...
                                    <#list spec.attributeValue as v >
                                        <dd><a href="javascript:;" :class="isSelected('${spec.attributeName}','${v}')?'selected':''"
                                               @click="selectSpec('${spec.attributeName}','${v}')">
                        ...
                        <div class="summary-wrap">
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        <input autocomplete="off" type="text" value="1" minnum="1" class="itxt" v-model="buyNum"/>
